  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('FileType', {
      ...
      callback = function()
        ...
        vim.api.nvim_buf_set_keymap(0, 'n', '[[', ':lua require("kulala").jump_prev()<CR>', { desc = 'Jump previous request' })
        vim.api.nvim_buf_set_keymap(0, 'n', ']]', ':lua require("kulala").jump_next()<CR>', { desc = 'Jump next request' })
      end,
    })
  end,
}
